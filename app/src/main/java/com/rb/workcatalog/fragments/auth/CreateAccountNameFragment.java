 ...
 * Use the {@link CreateAccountNameFragment#newInstance} factory method to
...
public class CreateAccountNameFragment extends Fragment {
     ...
     * @return A new instance of fragment CreateAccountNameFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static CreateAccountNameFragment newInstance(String param1, String param2) {
        CreateAccountNameFragment fragment = new CreateAccountNameFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                currentActivity.backStackSlideReplaceToFragment(new CreateAccountEmailFragment());
