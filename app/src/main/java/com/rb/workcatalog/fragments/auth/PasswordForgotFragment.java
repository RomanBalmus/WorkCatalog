 ...
 * Use the {@link PasswordForgotFragment#newInstance} factory method to
...
public class PasswordForgotFragment extends Fragment {
    ...
    PasswordForgotListener mCallback;
    ...
    public static PasswordForgotFragment newInstance(String param1, String param2) {
        PasswordForgotFragment fragment = new PasswordForgotFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        closeBtn=(ImageButton)view.findViewById(R.id.password_back_btn);
